    ...
    return (
       <SafeAreaView style={{flex:1,height:hp(100),backgroundColor:'white'}}>
            ...
            <View style={{backgroundColor:'white', borderBottomColor: '#DDDDDD',
                        borderBottomWidth: 1,marginTop:hp(1)}}>
                <Headerpartner />
                <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, elevation: 1, marginTop: 47,backgroundColor:'white' }}>
                    <Image
            ...
            <ScrollView style={{backgroundColor:'white',height:hp(100)}}>
                ...
                <View style={styles.bottomContainer}>
                    <View style={[styles.subContainer, { justifyContent: 'space-between', marginTop: 32 }]}>
                    <TouchableOpacity onPress={() => {
              navigation.navigate('Withdraw-p');}}>
                        {
                            <RenderMenuItem title={'Withdraw Fund'} imageUrl={require('../../Assets/withdraw_fund.png')} />
                        }
                        </TouchableOpacity>
                        ...
                        <View style={styles.subContainer}>
                            ...
                            />
                            <Text style={[styles.title, { marginLeft: 10, marginRight: 30 }]}>0.00 USD</Text>
                        </View>
                    </View>
                    <TouchableOpacity onPress={() => {
              navigation.navigate('Reports-p');
                    ...
                    {
                        <RenderMenuItem title={'My Reports'} imageUrl={require('../../Assets/reports.png')} />
                    }
                    </TouchableOpacity>
                </View>
                <View
              ...
              navigation.navigate('Jobs-p');
                    ...
                    {
                        <RenderMenuItem title={'Jobs'} imageUrl={require('../../Assets/jobs.png')} />
                    }
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {
              navigation.navigate('Social-p');
                    ...
                    {
                        <RenderMenuItem title={'Social tools'} imageUrl={require('../../Assets/grayShare.png')} />
                    }
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {
              navigation.navigate('Tutorials-p');
                    ...
                    {
                        <RenderMenuItem title={'Tutorials'} imageUrl={require('../../Assets/Tutorial.png')} />
                    }
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {
              navigation.navigate('Recruter-p');
                    ...
                    {
                        <RenderMenuItem title={'Join as Recruiter'} imageUrl={require('../../Assets/recrutar.png')} />
                    }
                    </TouchableOpacity>
                    <TouchableOpacity
            //          onPress={() => {
            //   navigation.navigate('Customer-p'); }}
              >
                    {
                        <RenderMenuItem title={'Support'} imageUrl={require('../../Assets/support.png')} />
                    }
                    </TouchableOpacity>
                    <TouchableOpacity 
            //         onPress={() => {
            //   navigation.navigate('Referpartner1-p');}}
              >
                    {
                        <RenderMenuItem title={'Log Out'} imageUrl={require('../../Assets/logout.png')} />
                    }
                    </TouchableOpacity>
                ...
                <View style={{ paddingLeft: 16, backgroundColor: '#DDDDDD' }}>
                    <Text style={{ paddingTop: 8, fontWeight: 'bold', fontSize: 16 }}>Need Help? Call Now:</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 27, marginTop: 16 }}>
                        <Image
