    ...
    return (
        ...
        <ScrollView style={{height:hp(100)}}>
            <View >
                ...
                <View style={{ backgroundColor: colors.cardBg, paddingHorizontal: 16, paddingVertical: 24, borderRadius: 8, marginTop: 32, marginHorizontal: 16 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: hp(2), }}>
                        ...
                        <TouchableOpacity style={{ backgroundColor: colors.green, paddingHorizontal: wp(6), paddingVertical: hp(1.5) }}>
                            <Text style={{ textAlign: 'center', fontWeight: 'bold', color: 'white', fontSize: 16, marginTop: 8 }}>USD</Text>
                        </TouchableOpacity>
                    </View>
                    <TouchableOpacity >
                ...
                <View style={{ borderWidth: 1, borderColor: colors.darkGray, paddingHorizontal: wp(4), marginTop: hp(4), paddingVertical: hp(3) }}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold' }}>Other Payment Options</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: wp(4), marginTop: hp(3) }}>
